...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{% url 'teacher_statistics' %}" class="nav-link">Feedback</a>
        </li>
        {% if user.is_superuser %}
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{% url 'teacher-registration' %}" class="nav-link">Register Teacher</a>
        </li>
        {% endif %}
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{% url 'teacher-change-details' %}" class="nav-link">Change Details</a>
        </li>
    </ul>
