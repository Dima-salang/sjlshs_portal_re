...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    {% block logo %}
        <a href="/" class="brand-link">
            <img src="{%static 'images/sjlshs_croppedV4.png' %}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            {% block logo_text %}<span class="brand-text font-weight-light">SJLSHS Admin</span>{% endblock %}
        </a>
    {% endblock %}
